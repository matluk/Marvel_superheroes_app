    ...
    <div className='sh__item_page'>
      <div className='container'>
        <div className='sh__item_page-header'>
          ...
          <span className='sh__item_page-header-count_pill'>{favorites.length} {favorites.length === 1 ? 'Item' : 'Items'}</span>
        </div>
        ...
        {favorites.length > 0 ? (
          ...
          <h2 className="sh__item_page-no_items">No items in your list, add some!</h2>
        )}
